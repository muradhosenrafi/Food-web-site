...
const SpecialOffer = () => {
  ...
  return (
    <div className="bg-gradient-to-b from-[#1a1212] to-[#2a1e1e] text-white py-16 px-4 font-poping">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-14">
          <h1 className="text-5xl font-bold mb-4 transform transition-all bg-gradient-to-r from-amber-400 to-red-500 bg-clip-text text-transparent font-diploy italic">
              ...
              return (
                ...
                >
                  ...
                  <div className="p-6 relative z-10 ">
                       <h3 className="text-2xl font-bold mb-2 bg-gradient-to-r from-amber-300 to-amber-500 bg-clip-text text-transparent font-diploy italic ">
                           {item.title}
                       </h3>
                          ...
                          {cartItem ? (
                            <div className="flex items-center gap-3">
                               ...
                               : removeFromCart(item.id)
                                ...
                                <span className="w-8 text-center text-amber-100 font-cngel ">
                                      {quantity}
                                </span>
                            ...
                            <button onClick={() => addToCart({...item, name: item.title, price:parseFloat(item.price.replace('$', ''))  } , 1)} className={ `${addButtonBase} ${addButtonHover} ${commonTransition} `}>
